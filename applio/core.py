...
def run_tts_script(
    ...
    tts_script_path = os.path.join("rvc", "rvc", "lib", "tools", "tts.py")
...
def run_extract_script(
    ...
    extract = os.path.join("applio", "rvc", "train", "extract", "extract.py")
...
def run_train_script(
    ...
    train_script_path = os.path.join("applio", "rvc", "train", "train.py")
    command = [
        python,
        train_script_path,
        *map(
